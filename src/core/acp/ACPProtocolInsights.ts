    ...
    return [
      {
        ...
        detail: "Method probe summary reported 0/25 support and 25/25 method-not-found.",
        impact:
          "Treat hard stop as unsupported by default; prefer session/cancel for turn cancellation.",
      },
      {
        capability: "session/list",
        detail: "Support exists but is optional and inconsistent across agents.",
        impact: "UI and orchestrator logic must feature-detect session listing before invoking it.",
      },
      {
        capability: "session/fork and session/resume",
        detail: "These are optional capabilities and not broadly implemented.",
        impact: "Expose only when advertised in initialize sessionCapabilities.",
      },
      {
